...
export default function CareAndSupportContainer() {
  ...
  return (
    <CareAndSupportImageDivContainer>
      <ImgSlider data={data} slidersetting={slidersetting} />

      <MainContainer>
        <h1>CareAndSupport Container </h1>
        <h1>CareAndSupport Container </h1>
        <h1>CareAndSupport Container </h1>
        <h1>CareAndSupport Container </h1>
        <h1>CareAndSupport Container </h1>
...
const CareAndSupportImageDivContainer = styled.div`
  position: relative;
  top: 60px;
`;
